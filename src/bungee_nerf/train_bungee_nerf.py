...
def parse_args():
    ...
    parser.add_argument("--num_stages", type=int, default=4,
                       help="Number of progressive stages")
    ...
    parser.add_argument("--num_freqs_base", type=int, default=4,
                       help="Base number of frequency bands")
    parser.add_argument("--num_freqs_max", type=int, default=10,
                       help="Maximum number of frequency bands")
    
    # Training arguments
    parser.add_argument("--trainer_type", type=str, default="progressive",
                       choices=["base", "progressive", "multiscale"],
    ...
    parser.add_argument("--steps_per_stage", type=int, default=50000,
    ...
    parser.add_argument("--progressive_loss_weight", type=float, default=0.05,
...
def create_config(args) -> BungeeNeRFConfig:
    ...
    config = BungeeNeRFConfig(
        ...
        # Positional encoding
        num_freqs_base=args.num_freqs_base,
        num_freqs_max=args.num_freqs_max,
        include_input=True,
